            ...
            <div className="col-12">
              <div className="title-heading text-center">
                <h5 className="heading fw-semibold sub-heading text-white title-dark">
                  Meet Spectral Fusion NFT
                </h5>
                <p className="text-white-50 para-desc mx-auto mb-0">
                Welcome to Spectral Fusion NFT, a real estate-based blockchain project that aims to revolutionize the way we buy, sell, and manage real estate assets.
                </p>
              </div>
            </div>
            {/*end col*/}
            ...
            <div className="col">
              <div className="section-title text-center mb-4 pb-2">
                ...
                <p className="text-muted para-desc mb-0 mx-auto">
                  ...
                  artists of all Spectral Fusion NFT with their fans and unique token
                  collectors!
                </p>
              </div>
            </div>
