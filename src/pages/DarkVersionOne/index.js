            ...
            <div className="col-lg-7 col-md-6">
              <div className="title-heading">
                ...
                <p className="text-white-50 para-desc mb-0 mb-0">
                  ...
                  artists of all Spectral Fusion NFTs with their fans and unique token
                  collectors!
                </p>
                    ...
                    <div className="col">
                      <div className="section-title text-center mb-4 pb-2">
                        <h4 className="title text-white title-dark mb-4">
                          Join the fastest growing Spectral Fusion NFTs <br /> with more
                          than 2000+ NFTs
                        </h4>
                        <p className="text-white-50 para-desc mb-0 mx-auto">
                          We are a huge marketplace dedicated to connecting
                          great artists of all Spectral Fusion NFTs with their fans and
                  ...
                  <div className="row">
                    <div className="col-md-6 mt-4 pt-2">
                      <div className="card p-4 rounded-md shadow bg-white">
                        ...
                        <p className="text-muted mb-0">
                          We are a huge marketplace dedicated to connecting
                          great artists of all Spectral Fusion NFTs.
                        </p>
                    ...
                    <div className="col-md-6 mt-4 pt-2">
                      <div className="card p-4 rounded-md shadow bg-white">
                        <h4 className="mb-4">Learn more about Spectral Fusion NFTs</h4>
                        <p className="text-muted mb-0">
                          We are a huge marketplace dedicated to connecting
                          great artists of all Spectral Fusion NFTs.
                        </p>
