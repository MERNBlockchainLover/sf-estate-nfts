            ...
            <div className="row">
              <div className="col-xl-8 col-lg-7 col-md-6">
                <h5 className="text-light fw-normal title-dark">
                  Download the SFESTATE app to get the best experience
                </h5>
              ...
              <div className="col-xl-4 col-lg-5 col-md-6 mt-4 mt-sm-0">
                ...
                <ul className="list-unstyled social-icon foot-social-icon mb-0 mt-4 text-lg-end">
                  ...
                  >
                    <a href="https://www.facebook.com/SFESTATE" className="rounded">
                  ...
                  <li
                    ...
                    style={{ paddingRight: 3 }}
                  >
                    <a href="https://www.instagram.com/SFESTATE/" className="rounded">
                  ...
                  <li
                    ...
                    style={{ paddingRight: 3 }}
                  >
                    <a href="https://www.linkedin.com/company/SFESTATE/" className="rounded">
                  ...
                  <li
                    ...
                    style={{ paddingRight: 3 }}
                  >
                    <a href="https://twitter.com/SFESTATE" className="rounded">
                  ...
                  <li
                    ...
                    style={{ paddingRight: 3 }}
                  >
                    <a href="https://t.me/SFESTATE" className="rounded">
              ...
              <div className="footer-py-60 footer-border">
                <div className="row">
                  <div className="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                    ...
                    SFESTATE is a blockchain project that uses Ethereum technology to digitize real estate assets worldwide
                    </p>
                  </div>
                  {/*end col*/}

                  <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <h5 className="footer-head">SFESTATE</h5>
